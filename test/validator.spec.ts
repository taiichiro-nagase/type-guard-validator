import { array, assertOf, boolean, literal, nullable, nullOr, number, object, string, tuple, typeOf, undefinedable, undefinedOr, union, valueOf } from "../src/validator";
...
describe("assertOf", () => {
  it("asserts correctly", () => {
    expect(() => assertOf(string)("root", "string")).not.toThrowError();
    expect(() => assertOf(string)("root", 1)).toThrowError("root is not string: 1");
  });
});